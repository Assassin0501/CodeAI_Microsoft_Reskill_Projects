...
ax = df['Score'].value_counts().sort_index().plot(kind = 'bar' , title = 'Count of Reviews by Stars' , figsize = (10,5) , color = 'red')
...
sia.polarity_scores('I hate you but I like your good qualitites ')
...
#plotting the vaders resuts
ax = sns.barplot(data = vaders , x = 'Score' , y = 'compound' , color = 'green')
